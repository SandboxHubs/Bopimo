...
require_once("/var/www/vernium.net/render-testing/render-class.php");
class bopimo {
	public $pdo = false;

	public function __construct () {
		$this->pdo = new PDO( 'epiz_27473052_YES', 'epiz_27473052', 'rbnse4J7BiXBoaT' ); //declare PDO
	}
	/*
	BASIC FUNCTIONS
	*/
	...
	{
		$pdo = new PDO( 'epiz_27473052_YES', 'epiz_27473052', 'rbnse4J7BiXBoaT' );  //declare PDO
	...
	{
		$pdo = new PDO( 'epiz_27473052_YES', 'epiz_27473052', 'rbnse4J7BiXBoaT' ); 
	...
	*/
	...
	{
		require("/var/www/vernium.net/site/footer.php");
	}

	public function notFound()
	{
		require("/var/www/vernium.net/error/404.php");
	}
